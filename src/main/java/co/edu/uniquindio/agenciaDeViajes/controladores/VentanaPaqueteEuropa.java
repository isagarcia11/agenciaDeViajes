...
public class VentanaPaqueteEuropa implements Initializable, CambioIdiomaListener {
    @FXML
    ...
    private void actualizarTextos() {
        tituloPaquete.setText(propiedades.getResourceBundle().getString("TextoTituloPaquete1"));
        ...
        duracionPaquete.setText(propiedades.getResourceBundle().getString("TextoDuracionPaquete1"));
        servAdicionalesPaquete.setText(propiedades.getResourceBundle().getString("TextoServiciosPaquete1"));
        precioPaquete.setText(propiedades.getResourceBundle().getString("TextoPrecioPaquete1"));
        cupoMaximoPaquete.setText(propiedades.getResourceBundle().getString("TextoCupoMaximoPaquete1"));
